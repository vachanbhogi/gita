...
# SWIFTUI IMPLEMENTATION OVERRIDE
- CRITICAL: The target codebase is native Swift/SwiftUI. 
- Ignore web requirements like CSS, React, `will-change`, or DOM events.
- Implement the physics, 300ms caps, 0.97 scale-presses, and spring curves using SwiftUI modifiers like `withAnimation`, `.scaleEffect()`, and `.gesture()`.
